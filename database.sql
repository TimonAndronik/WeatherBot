...
INSERT INTO `users` VALUES (8,878216640,'Shmatoq','2025-02-25 11:20:44'),(9,820062347,'Анонім','2025-02-25 11:22:00');
...
CREATE TABLE `weatherrequests` (
  ...
  PRIMARY KEY (`Id`),
  KEY `UserId` (`UserId`),
  CONSTRAINT `weatherrequests_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `users` (`Id`)
...
-- Dump completed on 2025-02-25 22:34:00
