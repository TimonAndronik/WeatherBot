...
namespace WeatherBot
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<ITelegramBotClient>(new TelegramBotClient("7799928283:AAESCCosJnkx9NRR6D-PwKT9gIBFdFAWrqs"));
        ...
        static async Task HandleUpdate(ITelegramBotClient botClient, Telegram.Bot.Types.Update update, CancellationToken cancellationToken)
        {
            ...
            string userName = message.Chat.Username ?? "Анонім";
            int userId = await database.AddUserAsync(telegramId, userName);
